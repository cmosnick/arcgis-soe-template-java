...
import static com.esri.arcgis.soe.template.util.LogConstants.*;
...
public class LogAdaptor extends MarkerIgnoringBase {
    ...
    void write(int level, StringBuilder buf, Throwable t) {
        ...
        if (log != null) {
            try {
                log.addMessage(level, LOG_MESSAGE_CODE_UNKNOWN,
                        writer.toString());
            } catch (IOException e) {
    ...
    public void debug(String msg) {
        log(LOG_LEVEL_DETAILED, msg, null);
    }

    @Override
    public void debug(String format, Object arg) {
        formatAndLog(LOG_LEVEL_DETAILED, format, arg, null);
    }

    @Override
    public void debug(String format, Object arg1, Object arg2) {
        formatAndLog(LOG_LEVEL_DETAILED, format, arg1, arg2);
    }

    @Override
    public void debug(String format, Object... arguments) {
        formatAndLog(LOG_LEVEL_DETAILED, format, arguments);
    }

    @Override
    public void debug(String msg, Throwable t) {
        log(LOG_LEVEL_DETAILED, msg, t);
    }

    @Override
    public void info(String msg) {
        log(LOG_LEVEL_NORMAL, msg, null);
    }

    @Override
    public void info(String format, Object arg) {
        formatAndLog(LOG_LEVEL_NORMAL, format, arg, null);
    }

    @Override
    public void info(String format, Object arg1, Object arg2) {
        formatAndLog(LOG_LEVEL_NORMAL, format, arg1, arg2);
    }

    @Override
    public void info(String format, Object... arguments) {
        formatAndLog(LOG_LEVEL_NORMAL, format, arguments);
    }

    @Override
    public void info(String msg, Throwable t) {
        log(LOG_LEVEL_NORMAL, msg, t);
    }

    @Override
    public void warn(String msg) {
        log(LOG_LEVEL_WARNING, msg, null);
    }

    @Override
    public void warn(String format, Object arg) {
        formatAndLog(LOG_LEVEL_WARNING, format, arg, null);
    }

    @Override
    public void warn(String format, Object arg1, Object arg2) {
        formatAndLog(LOG_LEVEL_WARNING, format, arg1, arg2);
    }

    @Override
    public void warn(String format, Object... arguments) {
        formatAndLog(LOG_LEVEL_WARNING, format, arguments);
    }

    @Override
    public void warn(String msg, Throwable t) {
        log(LOG_LEVEL_WARNING, msg, t);
    }
    ...
    public boolean isDebugEnabled() {
        return isLevelEnabled(LOG_LEVEL_DETAILED);
    }

    @Override
    public boolean isInfoEnabled() {
        return isLevelEnabled(LOG_LEVEL_NORMAL);
    }
