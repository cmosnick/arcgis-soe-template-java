...
import com.esri.arcgis.soe.template.rest.api.ErrorObject;
import com.esri.arcgis.soe.template.rest.json.JSONConverter;
import com.esri.arcgis.soe.template.security.SecurityContext;
import com.esri.arcgis.soe.template.server.internal.UriPath;
import com.esri.arcgis.soe.template.util.ArcObjectsInteropException;
import com.esri.arcgis.soe.template.util.ArcObjectsUtilities;
import com.esri.arcgis.soe.template.util.StopWatch;
...
public abstract class AbstractRestServerObjectExtension implements
    ...
    protected byte[] handleError(int code, String message, String[] details)
            throws IOException {
        String errorJSON = objectMapper.writeValueAsString(new com.esri.arcgis.soe.template.rest.api.Error(
